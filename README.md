...
1.2. Принимай такие решения, которые увеличивают твои возможности и старайся не принимать таких которые их сокрощают.

1.3. Ты должен знать, что достоин самого лучшего и можешь это получить - стоит лишь только пожелать. Чаще желай, ни о чем не думая и все повернется так что твои желания исполнятся.

1.4. Не следуй чужим правилам, имей всегда свои. Если что-то для всех запрещено, то подумай хорошо, может быть все уже забыли откуда взялся запрет и его давно можно нарушить (в помощь п.1.1)

1.5. Не будь частью толпы. Толпой всегда манипулируют с целью извлечения из них прибыли. Поэтому цени одиночество, познавай себя и старайся быть собою.

1.6. Некоторые решения требуют времени. Если не уверен, то дай вопросу время на созревание. Решение может прийти через день, а может через месяц и оно будет лучше чем то которое ты хотел принять сразу.
...
2.6. Любую проблему можно решить при помощи денег, если у тебя есть деньги значит у тебя нет проблем.

2.7. Выгодней всего вкладывать деньги в свое развитие.

2.8. Ставь гипотезы и выделяй деньги на эксперименты, если ничего не получится ты должен быть готов их потерять ради полученного опыта, это нормально
...
Чтобы не случилось помни что у тебя есть семья, которая тебя всегда поддержит.
